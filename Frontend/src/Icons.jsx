...
export const AlertCircleIcon = ({ size = 18 }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const SparklesIcon = ({ size = 20 }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 3l1.912 5.813 6.088.087-4.873 3.687 1.812 5.913-4.939-3.587-4.939 3.587 1.812-5.913-4.873-3.687 6.088-.087z"></path>
        <path d="M5 3l.637 1.938 2.03.029-1.624 1.229.605 1.971-1.648-1.196-1.648 1.196.605-1.971-1.624-1.229 2.03-.029z"></path>
        <path d="M19 3l.637 1.938 2.03.029-1.624 1.229.605 1.971-1.648-1.196-1.648 1.196.605-1.971-1.624-1.229 2.03-.029z"></path>
    </svg>
);
